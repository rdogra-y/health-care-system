  ...
  return (
    <div className="patients-page">
      <header className="page-header">
        <div>
          <span className="section-tag">PATIENT DIRECTORY</span>
          <h1>People under your care.</h1>
          <p>
            Search, register and manage patient records from one workspace.
          </p>
        </div>
            ...
            <div className="patient-row" key={patient.id}>
              <div className="patient-identity">
                ...
                <div>
                  ...
                  <span>Patient #{String(patient.id).padStart(4, "0")}</span>
                </div>
              </div>

              <div className="patient-detail">
                <strong>{patient.email || "No email"}</strong>
        ...
        >
          ...
          >
            <div className="modal-heading">
              <div>
                <span className="section-tag">NEW RECORD</span>
